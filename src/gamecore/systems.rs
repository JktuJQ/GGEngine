...
/// [`SystemId`] id struct is needed to identify [`System`]s.
///
/// # Note
/// This id struct is different from others such as
/// [`ComponentId`](crate::gamecore::components::ComponentId),
/// [`ResourceId`](crate::gamecore::resources::ResourceId) and
/// [`EventId`](crate::gamecore::events::EventId).
...
/// ([`ComponentQuery`], [`ResourceQuery`], [`EventQuery`]).
///
...
/// up to 3 query type arguments are implementors of [`System`] trait.
///
